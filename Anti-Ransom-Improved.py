...
# ✅ تدريب النموذج تلقائيًا إذا لم يكن موجودًا
...
def main():
    ...
    st.info("📌 If you're on Replit, click the 'Open in new tab' button at the top-right to view the app.")
